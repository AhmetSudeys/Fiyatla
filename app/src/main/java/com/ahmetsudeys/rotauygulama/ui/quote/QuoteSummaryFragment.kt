...
import com.ahmetsudeys.rotauygulama.databinding.FragmentQuoteSummaryBinding
import com.ahmetsudeys.rotauygulama.databinding.BottomsheetDiscountBinding
...
class QuoteSummaryFragment : Fragment() {
    ...
    private fun completeQuote() {
        ...
        val status = QuoteDraftStore.editingStatus ?: com.ahmetsudeys.rotauygulama.data.quote.QuoteStatus.PENDING
        ...
        QuoteStorage.upsertQuote(
            ...
            QuoteStorage.QuoteRecord(
                ...
                customerAddress = com.ahmetsudeys.rotauygulama.data.customer.CustomerStorage.AddressParts(
