...
import com.ahmetsudeys.rotauygulama.databinding.ItemMaterialTotalBinding
import com.ahmetsudeys.rotauygulama.databinding.ItemMaterialRowBinding
            ...
            fun bind(item: MaterialItem, dfQty: DecimalFormat, money: NumberFormat, excelStyle: Boolean, position: Int) {
                if (excelStyle) {
                    val bg = if (position % 2 == 0) {
                        com.ahmetsudeys.rotauygulama.R.color.surface_white
                    } else {
                        com.ahmetsudeys.rotauygulama.R.color.bg_light
                    }
