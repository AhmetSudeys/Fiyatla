...
import com.ahmetsudeys.rotauygulama.databinding.FragmentQuotesBinding
...
class QuotesFragment : Fragment() {
    ...
    private fun applyFilterNow() {
        ...
        val base = when (statusFilter) {
            ...
            StatusFilter.PENDING -> allQuotes.filter { it.status == com.ahmetsudeys.rotauygulama.data.quote.QuoteStatus.PENDING }
            StatusFilter.APPROVED -> allQuotes.filter { it.status == com.ahmetsudeys.rotauygulama.data.quote.QuoteStatus.APPROVED }
            StatusFilter.REJECTED -> allQuotes.filter { it.status == com.ahmetsudeys.rotauygulama.data.quote.QuoteStatus.REJECTED }
        }
