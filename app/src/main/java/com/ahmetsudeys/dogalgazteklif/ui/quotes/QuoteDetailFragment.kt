...
import com.ahmetsudeys.dogalgazteklif.databinding.FragmentQuoteDetailBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        ioExecutor.execute {
            ...
            mainHandler.post {
                ...
                binding.toolbar.inflateMenu(com.ahmetsudeys.dogalgazteklif.R.menu.menu_quote_detail)
                binding.toolbar.setOnMenuItemClickListener { item ->
                    when (item.itemId) {
                        com.ahmetsudeys.dogalgazteklif.R.id.action_edit_quote -> {
                            QuoteDraftStore.loadFromRecord(record)
                            findNavController().navigate(com.ahmetsudeys.dogalgazteklif.R.id.action_quoteDetailFragment_to_quote_nav_graph)
                            true
                        }
