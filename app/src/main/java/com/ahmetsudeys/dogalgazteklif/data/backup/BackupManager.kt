...
import com.ahmetsudeys.dogalgazteklif.ui.onboarding.BackupDownloadActivity
import java.io.File
...
object BackupManager {
    ...
    fun startShare(context: Context, uri: Uri, chooserTitle: String) {
        val shareIntent = Intent(Intent.ACTION_SEND).apply {
            ...
            putExtra(Intent.EXTRA_SUBJECT, "Doğalgaz Teklif Fiyatlandırma - Veri Yedeği")
    ...
    private fun summarySheet(context: Context): XlsxWriter.Sheet {
        ...
        val rows = listOf(
            listOf(XlsxWriter.text("Doğalgaz Teklif Fiyatlandırma - Veri Yedeği")),
