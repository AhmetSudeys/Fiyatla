package com.ahmetsudeys.dogalgazteklif.data.ledger
 ...
 *
 * Mirrors the existing SharedPreferences + JSON pattern used by [com.ahmetsudeys.dogalgazteklif.data.customer.CustomerStorage]
 * and [com.ahmetsudeys.dogalgazteklif.data.quote.QuoteStorage]. Each ledger account is keyed by the
 * customer's [com.ahmetsudeys.dogalgazteklif.data.customer.CustomerStorage.CustomerRecord.createdAtMillis].
 */
